...
def generate_report(differences):
    ...
    messages = [
        {"role": "system", "content": "당신은 선박 설계 전문가 입니다. 주로 가스선을 설계합니다. 제가 주는 자료는 표준 사양서와 프로젝트 사양서 입니다. 당신은 사양서 비교 전문가입니다. 아래 Word 양식에 따라 차이점을 한국어로 분석하고 설명하는 보고서를 작성해주세요. 제목과 개요는 포함하지 마세요.섹션별로 구분해주고 "},
        {"role": "user", "content": f"""
